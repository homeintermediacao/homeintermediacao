...
require_once($_SERVER["DOCUMENT_ROOT"] . "/homeintermediacao/classes/Conexao.php");
...
class Noticia_DAO
{
    ...
    public function consultar($Id = null, $Titulo = null, $Resumo = null, $Total_registros = null, $Ordenacao = null)
    {
        $Not[] = array();
        ...
        if ($Ordenacao != null)
        {
            $Query = $Query . " order by dataHoraGravacao ". $Ordenacao;
        }
